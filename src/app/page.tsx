                ...
                >
                  <div className='mt-8 mt-[-100px] h-full w-full py-40 md:mt-0'>
                    ...
                    <div className='mt-4 text-base text-gray-100 md:text-lg'>
                      <Tooltip withUnderline tipChildren={<></>}>
                        At <span>Moon Education Center </span>
                      </Tooltip>
                      our team of dedicated educators and experts is here to
                ...
                >
                  ...
                  <div className='mt-8 h-full w-full md:mt-0'>
                    ...
                    <div className='mt-4 text-base text-gray-100 md:text-lg'>
                      ...
                      we take pride in what we have to offer. Our arsenal
                      comprises a
                      <strong className='text-gray-100 '>
